...
namespace DialogueSystem
{
    public class ExtraDialogue
    {
        ...
        public string[,,] answerIndex = new string[4, 4, 4] { {         { "...", "Uh, cool... How do I look like?", "Ill bet you have, hopefully you wont be here for much longer...", "Are you still drunk, how is that even possible?" }, // 000, 001, 002, 003
                                                                ...
                                                                {       { "Okay, dont worry, you suffered from head trauma, a temporary loss of memory is usual.", "Okay, so your memory is not on a complete zero, close, but not zero, at least.", "Oh just luck off, and take that god with you! [End conversation]", "hytopt0-2" },  // 200, 201, 202, 203
                                                                        ...
                                                                        { "[Mutters something] why doesnt he return my messages? Ah, were you saying something?", "Bgnk", "2D2", "hyhopt0-2" }, // 220, 221, 222, 223
